...
const IconDash      = () => <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>;
...
export default function App() {
  const [tab, setTab] = useState<"dash" | "daily" | "list" | "flash" | "quiz" | "para" | "write" | "speak">("dash");
  ...
  const tabs = [
    { id: "dash"  as const, label: "B1",     icon: <IconDash      /> },
      ...
      <main style={{ maxWidth: 600, margin: "0 auto", padding: "22px 16px 110px" }}>
        <div style={{ marginBottom: 22 }}>
          <h1 style={{ fontSize: 24, fontWeight: 700, color: text, marginBottom: 5 }}>
            {tab === "dash"  && "B1 Training Dashboard"}
            {tab === "daily" && "Daily Set"}
          ...
          <p style={{ fontSize: 15, color: sub, lineHeight: 1.5 }}>
            {tab === "dash"  && "Your daily execution guide. Tasks · diary · chapters · countdown."}
